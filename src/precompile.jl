function _precompile_()
    ...
    @assert precompile(HTTP.parse!, (HTTP.Request, HTTP.Parser, Array{UInt8, 1}, Int64, Bool, String, HTTP.Method, Task))
    @assert precompile(HTTP.parse!, (HTTP.Response, HTTP.Parser, Array{UInt8, 1}, Int64, Bool, String, HTTP.Method, Task))
