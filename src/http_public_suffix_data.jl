...
# Non-ASCII rules are omitted because HTTP.jl canonicalizes cookie hosts to ASCII.

const _PUBLIC_SUFFIX_EXACT_RULES = Set(String[
    "0.bg",
    "0am.jp",
    "0g0.jp",
    "0j0.jp",
...
const _PUBLIC_SUFFIX_WILDCARD_RULES = Set(String[
...
const _PUBLIC_SUFFIX_EXCEPTION_RULES = Set(String[
    "city.kawasaki.jp",
    "city.kitakyushu.jp",
    "city.kobe.jp",
    "city.nagoya.jp",
