function _precompile_()
    ...
    @assert precompile(HTTP.onheadervalue, (HTTP.Parser, HTTP.Response, Array{UInt8, 1}, Int64, Int64, Bool, String, Base.RefValue{String},))
    ...
    @assert precompile(HTTP.processresponse!, (HTTP.Client, HTTP.Connection{Base.TCPSocket}, HTTP.Response, String, HTTP.Method, Task, Bool, Bool,))
    ...
    @assert precompile(HTTP.getbytes, (Base.TCPSocket,))
    ...
    @assert precompile(HTTP.processresponse!, (HTTP.Client, HTTP.Connection{MbedTLS.SSLContext}, HTTP.Response, String, HTTP.Method, Task, Bool, Bool,))
    ...
    @assert precompile(HTTP.URIs.splitpath, (String, Int64,))
    ...
    @assert precompile(HTTP.Cookies.hash, (HTTP.Cookies.Cookie, UInt64,))
    ...
    @assert precompile(HTTP.getbytes, (MbedTLS.SSLContext,))
    ...
    @assert precompile(HTTP.onheadervalue, (HTTP.Parser, HTTP.Request, Array{UInt8, 1}, Int64, Int64, Bool, String, Base.RefValue{String},))
    ...
    @assert precompile(HTTP.parse!, (HTTP.Request, HTTP.Parser, Array{UInt8, 1}, Int64, Bool, String, HTTP.Method, Int64, Int64, Int64, Task))
    @assert precompile(HTTP.parse!, (HTTP.Response, HTTP.Parser, Array{UInt8, 1}, Int64, Bool, String, HTTP.Method, Int64, Int64, Int64, Task))
