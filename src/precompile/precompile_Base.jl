function _precompile_1()
    ...
    precompile(Base.Dates.getslot, (String, Base.Dates.DelimitedSlot{Base.Dates.Year}, String, Int64,))
    ...
    precompile(Base.Dates.getslot, (String, Base.Dates.DelimitedSlot{Base.Dates.Second}, String, Int64,))
    ...
    precompile(Base.Dates.slotformat, (Base.Dates.DelimitedSlot{Base.Dates.DayOfWeekSlot}, Base.Dates.DateTime, String,))
    precompile(Base.Serializer.serialize_type, (Base.Serializer.SerializationState{Base.Pipe}, DataType,))
    precompile(Base.Dates.getslot, (String, Base.Dates.DelimitedSlot{Base.Dates.Hour}, String, Int64,))
    precompile(Base.with_output_color, (Function, Symbol, Base.TTY, String,))
    precompile(Base.Dates.getslot, (String, Base.Dates.DelimitedSlot{Base.Dates.Day}, String, Int64,))
    ...
    precompile(Base.Dates.getslot, (String, Base.Dates.DelimitedSlot{Base.Dates.Minute}, String, Int64,))
    precompile(Base.Test.do_test, (Base.Test.Returned, Symbol,))
    precompile(Base.vect, (Tuple{String, Array{UInt8, 1}, String},))
    precompile(Base.Dates.getslot, (String, Base.Dates.DelimitedSlot{Base.Dates.Month}, String, Int64,))
    ...
    precompile(Base.Dates.getslot, (String, Base.Dates.DelimitedSlot{Base.Dates.DayOfWeekSlot}, String, Int64,))
    ...
    precompile(Base.Dates.slotparse, (Base.Dates.DelimitedSlot{Base.Dates.Month}, String, String,))
    ...
    precompile(Base.find_vars, (UInt8, Array{Any, 1},))
    ...
    precompile(Base.safe_add, (UInt8, UInt8,))
    ...
    precompile(Base.Dates.parse, (Base.SubString{String}, Base.Dates.DateFormat,))
