...
{
    "location": "index.html#HTTP.Parsers.waitingforeof",
    "page": "Home",
    "title": "HTTP.Parsers.waitingforeof",
    "category": "Function",
    "text": "waitingforeof(::Parser)\n\nIs the Parser waiting for the peer to close the connection to signal the end of the Message Body?\n\n\n\n"
},

{
    "location": "index.html#HTTP.Parsers.seteof",
    "page": "Home",
    "title": "HTTP.Parsers.seteof",
    "category": "Function",
    "text": "seteof(::Parser)\n\nSignal that the peer has closed the connection.\n\n\n\n"
},

{
    "location": "index.html#HTTP.Parsers.connectionclosed",
    "page": "Home",
    "title": "HTTP.Parsers.connectionclosed",
    "category": "Function",
    "text": "connectionclosed(::Parser)\n\nWas \"Connection: close\" parsed?\n\n\n\n"
},

{
    "location": "index.html#HTTP.Parsers.setnobody",
    "page": "Home",
    "title": "HTTP.Parsers.setnobody",
    "category": "Function",
    "text": "setnobody(::Parser)\n\nTell the Parser not to look for a Message Body. e.g. for the Response to a HEAD Request.\n\n\n\n"
},
