...
@testitem "stringify(::Cookie)" begin
...
@testitem "SetCookieDoubleQuotes" begin
    cookiestrings = [
...
@testitem "Cookie sanitize value" begin
    values = Dict(
        "foo" => "foo",
        "foo;bar" => "foobar",
        "foo\\bar" => "foobar",
...
@testitem "Cookie sanitize path" begin
    paths = Dict(
        "/path" => "/path",
...
@testitem "HTTP.readcookies" begin
    testcookies = [
...
@testitem "Set-Cookie casing" begin
...
@testitem "Cookies.splithostport" begin
    testcases = [
    # Host name
