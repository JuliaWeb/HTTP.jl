...
@testitem "find_multipart_boundary" setup=[MultiPartSetup] begin
    using HTTP.MultiPartParsing: find_multipart_boundary
...
@testitem "parse_multipart_form request" setup=[MultiPartSetup] begin
    using HTTP.MultiPartParsing: parse_multipart_form
    @test parse_multipart_form(generate_non_multi_test_request()) === nothing

    multiparts = parse_multipart_form(generate_test_request())
...
@testitem "parse_multipart_form response" setup=[MultiPartSetup] begin
    using HTTP.MultiPartParsing: parse_multipart_form
    multiparts = parse_multipart_form(generate_test_response())
    @test 5 == length(multiparts)
